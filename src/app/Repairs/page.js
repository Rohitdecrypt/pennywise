  ...
  return (
    <div className="pr-5 w-full ">
      <div className="flex mt-5 w-full items-center">
        <div className="text-center text-[#000000] font-bold">Repairs</div>
      ...
      <div className="flex items-center justify-between mt-5">
        <div className="relative flex items-center">
          ...
          />
          <div className="text-black text-[12px] underline w-[200px] cursor-pointer">
            All Repairs
          </div>
        </div>
        <div>
      ...
      <div className="flex justify-between mt-5">
        <div className="flex">
          <div className="w-[155px] h-[48px] border-black border rounded-md bg-[#000] flex items-center justify-center cursor-pointer text-[#fff]">
            <MdDone size={25} /> <span className="pl-3">Collected</span>
          </div>
          <div className="w-[155px] h-[48px] border-black border rounded-md bg-[#000] flex items-center justify-center cursor-pointer text-[#fff] mx-2">
            <RxCross2 size={25} /> <span className="pl-3">Cancel</span>
          </div>
          <div className="w-[155px] h-[48px] border-black border rounded-md bg-[#000] flex items-center justify-center cursor-pointer text-[#fff] me-2">
            <AiOutlineReload size={25} /> <span className="pl-3">Return</span>
          </div>
          <Link href='/Repairs/ReturnOther'>

          <div className="w-[155px] h-[48px] border-black border rounded-md bg-[#fff] flex items-center justify-center text-[#000] cursor-pointer me-2">
            Return Other
          </div>
          </Link>
        </div>
