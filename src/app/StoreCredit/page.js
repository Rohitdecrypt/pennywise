          ...
          <table className=" min-w-full text-[#000000] ">
            <thead className="sticky top-0 bg-[#fff] py-2">
              <tr className="border-b border-[#BFBFBF]  text-sm">
                ...
                <th className="text-start py-3 font-normal max-w-[190px]">
                  Customer
                </th>
                <th className="text-start py-3 font-normal">
                  Type
                </th><th className="text-start py-3 font-normal max-w-[190px]">
                  Comment
                </th><th className="text-start py-3 font-normal">
                 Total Amount
                </th><th className="text-start py-3 font-normal">
                 Total Used
                </th><th className="text-start py-3 font-normal">
...
DSGHRTA                </td>
                <td className="py-3 font-light max-w-[190px]" >
