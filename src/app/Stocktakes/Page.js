    ...
    <div className="w-full pr-5 relative max-w-screen overflow-x-hidden">
      ...
      <div className="flex justify-between mt-5">
        <div className="flex">
          ...
          <Link href='/Stocktakes/StocktakeEntry'>
      ...
      <div
        className={
          sideOpen
            ? "variance-side h-screen absolute w-[456px] top-0 z-10 bg-[#fff] right-0  p-10 shadow-xl overflow-x-hidden transition-all duration-300"
            : "transition-all duration-300 variance-side h-screen absolute w-[406px] max-w-full overflow-x-hidden top-0 z-10 bg-[#fff] right-[-406px]  p-10 shadow-xl"
        }
      >
        ...
        <div className="flex mt-3">
          <div className="rounded-full w-16 py-1 bg-black text-white text-sm text-center">
            A-Z
          </div>
          <div className="rounded-full w-16 py-1 mx-2 text-black text-sm border border-[#A5A5A5] text-center">
            Z-A
          </div>
          <div className="rounded-full w-24 py-1  text-black text-sm border border-[#A5A5A5] text-center">
            Select All
          </div>
        </div>
        <div className="mt-8 h-[88%] overflow-x-hidden overflow-y-auto">
          <div>
